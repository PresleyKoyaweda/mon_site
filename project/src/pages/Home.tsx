...
import { ChevronRight, Brain, Database, Code, ArrowRight } from 'lucide-react';
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Avec une formation spécialisée en <strong>Data Engineering & Analytics</strong> et une 
                solide base en <strong>statistique décisionnelle</strong>, je conçois, déploie et opère 
                des solutions d'IA et de BI à fort impact. Je suis passionné par le <strong>NLP</strong>, 
                le <strong>MLOps</strong>, et la valorisation des données à travers des outils modernes 
                comme <strong>Power BI</strong>, <strong>LangChain</strong> ou <strong>MLflow</strong>.
              </motion.p>
