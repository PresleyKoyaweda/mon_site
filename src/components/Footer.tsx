...
const Footer = () => {
  const contactInfo = [
    { icon: <Phone size={18} />, text: '438-875-0712', href: 'tel:+14388750712' },
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              {['Accueil', 'À propos', 'Compétences', 'Projets', 'Solutions', 'Contact'].map((link) => (
                <li key={link}>
                  <motion.a
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="tel:+14388750712" className="hover:text-green-400 transition-colors">
                  438-875-0712
                </a>
              </div>
              <div className="flex items-center gap-2">
